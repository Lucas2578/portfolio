...
mongoose.connect(`mongodb+srv://${user}:${password}@${cluster}.${db_name}.mongodb.net/?retryWrites=true&w=majority`,
  ...
  .then(() => {
    ...
    //   { nameKey: 'sophiebluel', skillsRequire: ['javascript'], imagePreviewPaths: 'assets/images/projects/sophiebluel/sophiebluel_1.png', githubLink: 'https://github.com/Lucas2578/JavaScript-P3', imagePaths: { screen1: 'assets/images/projects/ohmyfood/sophiebluel_2.png', screen2: 'assets/images/projects/ohmyfood/sophiebluel_3.png', screen3: 'assets/images/projects/ohmyfood/sophiebluel_4.png' } },
    ...
    //   { nameKey: 'kalicraft', skillsRequire: ['projectmanagement', 'leadership', 'yml'], imagePreviewPaths: 'assets/images/projects/kalicraft/kalicraft_1.png', imagePaths: { screen1: 'assets/images/projects/kalicraft/kalicraft_2.png', screen2: 'assets/images/projects/kalicraft/kalicraft_3.png', screen3: 'assets/images/projects/kalicraft/kalicraft_4.png' } },
